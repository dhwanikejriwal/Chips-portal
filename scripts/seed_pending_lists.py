...
def run():
    ...
    l1_file = 'scripts/L1 Pending List (1) chips.xlsx'
    l2_file = 'scripts/L2 Pending List (1) chips.xlsx'
    op_file = 'scripts/Operator List (2) chips.xlsx'
    onboard_file = 'scripts/Onboard Pending List (1) chips.xlsx'
