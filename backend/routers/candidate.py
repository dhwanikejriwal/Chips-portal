...
def export_candidate_requests_backend(ids: str = None, db: Session = Depends(get_db)):
    """
    ...
    return generate_csv_export(serialized_records, column_mappings, "candidate_onboarding_requests", ids=ids)
